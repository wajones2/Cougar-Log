...
cursor.execute("""create table if not exists tutor (ROWID integer primary key autoincrement, first_name text, last_name text, discord_handle text, discord_tag text, date text, time text, date_updated text, time_updated text)""")
cursor.execute("""create table if not exists students (ROWID integer primary key autoincrement, mySID text, first_name text, last_name text, discord_handle text, discord_tag text, subject text, date text, time text, date_updated text, time_updated text)""") # Table of just students
